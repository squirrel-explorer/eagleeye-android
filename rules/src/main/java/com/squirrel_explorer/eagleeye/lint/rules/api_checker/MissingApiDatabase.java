...
public class MissingApiDatabase {
    ...
    private HashMap<Integer, HashMap<String, ArrayList<String>>> mRemovedDatabase =
            new HashMap<Integer, HashMap<String, ArrayList<String>>>();
    private HashMap<Integer, HashMap<String, ArrayList<String>>> mHideDatabase =
            new HashMap<Integer, HashMap<String, ArrayList<String>>>();
    ...
    private void put(HashMap<Integer, HashMap<String, ArrayList<String>>> db,
        ...
        if (db.containsKey(apiLevel)) {
            ...
            methodSet = new HashMap<String, ArrayList<String>>();
