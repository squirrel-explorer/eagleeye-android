...
```
其中，lint.xml的内容见本目录下的文件[lint.xml](https://github.com/squirrel-explorer/eagleeye-android/blob/master/documents/Lint%E5%BB%BA%E8%AE%AE%E4%BD%BF%E7%94%A8%E8%A7%84%E5%88%99/lint.xml) ：
```
